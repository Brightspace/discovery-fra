export default {
	...
	addedToMyLearningHeader: "Ajouté avec succès à Mes apprentissages", // Unused
	addedToYourList: "Ajouté à votre liste", // Unused
	all: "Tous", // The name of the homepage section for all activities.
	...
	backToDiscover: "Retour à Découvrir", //This breadcrumb will return the user to the homepage.
	...
	courseInfo: "Renseignements du cours", // A subtitle for displaying an area of information about a course
	...
	discoverHomeMessage: "Vous êtes sur la page d’accueil de l’outil Découvrir.", // Old message, unused.
	discovery: "Découvrir", //Old title text, unused.
	durationMinutes: "{minutes} minutes", // When viewing a course summary, this will display the duration of a course in minutes.
	emailFeedback: "Envoyez vos commentaires par courriel à l’adresse {email}", // Unused
	endDate: "Date de fin", // A subtitle for displaying the date a course will end
	endDateIsInThePast: "Ce cours est terminé depuis le {date}.", // A message describing the date a course was closed on.
	enrollInCourse: "S’inscrire au cours", // An action to enroll the user into the currently displayed course
	enrollmentHeaderFail: "Échec de l’inscription", // Displays as a header when there was an error enrolling into an activity
	enrollmentHeaderPending: "L’inscription est en attente", // Displays as a header when the enrollment is pending completion
	enrollmentHeaderSuccess: "Inscription effectuée avec succès", // Displays as a header when the user has been successfully enrolled into an activity
	enrollmentHeaderUnenrolled: "Aucun accès actuellement", // Displays as a header when the user was un-enrolled from an activity
	enrollmentMessageFail: "Impossible de vous inscrire en ce moment, veuillez réessayer plus tard.", // Displays when there was an issue enrolling into an activity, and to try again later.
	enrollmentMessagePending: "Votre inscription à ce cours est en attente, revenez bientôt pour accéder à ce cours.", // Displays when the enrollment is pending completion, and tells the user to check back shortly.
	enrollmentMessageSuccess: "{title} sera bientôt disponible dans le composant graphique Mes cours.", // Displays that the enrolled activity will be available via My Courses shortly.
	enrollmentMessageSuccessFuture: "{title} sera disponible dans le composant graphique Mes cours le {date}", // Displays that the enrolled activity will be available via My Courses on a certain date.
	...
	enrollmentMessageUnenrolled: "Un administrateur a annulé votre inscription, communiquez avec votre administrateur pour vous inscrire à nouveau.", // Displays when a user was un-enrolled by an activity by an administrator.
	...
	onMyList: "Sur ma liste", // Unused
	openCourse: "Ouvrir le cours", // An action that will open the currently displayed course in brightspace.
	or: "ou", //Unused
	pageAllLoadedMessage: "La page de cours a été chargée.", // Unused
	pageSelection: "À la page {pageCurrent} de {pageTotal}. Inscrivez un numéro de page pour accéder à celle-ci", // In a search's pagination component, shows the page number and how to navigate to a new page.
	...
	pagePrevious: "Aller à la page précédente", // When hovering over the previous button on a search's pagination page, this will navigate to the previous page.
	pageNext: "Aller à la page suivante",  // When hovering over the next button on a search's pagination page, this will navigate to the next page.
	...
	searchKeywords: "Rechercher les mots clés", // A subtitle for displaying a list of keywords associated with a course
	searchPageDocumentTitle: "Rechercher : {searchTerm} – Découvrir – {instanceName}", // Displays as the page/tab header for the search page.
	searchPlaceholder: "Recherche…", // Placeholder text for search inputs.
	searchResultCount: "{searchResultRange} de {searchResultsTotal} pour « {searchQuery} »", // When searching, displays the count of activities for the most recent search query.
	searchResultsOffscreen: "Résultats de recherche pour « {searchQuery} »", // Displays the search results for a search query have finished loading.
	searchResultsReadyMessage: "Page {pageCurrent} de {pageTotal} pour « {searchQuery} » est maintenant prête", // Unused
	searchResultCountForAllResults: "{searchResultRange} de {searchResultsTotal} résultats", // Displays a search's displayed number and maximum total of results.
	searchResultsReadyMessageForAllResults: "Page {pageCurrent} de {pageTotal} est maintenant prête", // Unused
	settings: "Réglages", // An action that opens up Discover's Settings page.
	...
	viewAllNewLabel: "Cliquer pour afficher les nouvelles activités", // Message that describes the view all action for new activities.
	viewAllUpdatedLabel: "Cliquer pour afficher les activités nouvellement mises à jour", // Message that describes the view all action for newly updated activities.
	viewMyList: "Afficher ma liste", // Unused
	welcomeToTheCourse: "Bienvenue au cours!", // Unused
};
